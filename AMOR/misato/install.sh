...
cp misatorc /usr/share/amor/

# Create the directory for images if it doesn't exist
mkdir -p /usr/share/amor/pics/animated/misato/

# Copy the shime1.png shime2.png files to the asuka_suit directory
cp shime1.png shime2.png /usr/share/amor/pics/animated/misato/

# Copy the png file to the preview directory
cp misato_preview.png /usr/share/amor/pics/preview/
