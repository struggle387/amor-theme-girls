...
cp rei_swimsuitrc /usr/share/amor/

# Create the directory for images if it doesn't exist
mkdir -p /usr/share/amor/pics/animated/rei_swimsuit/

# Copy the shime1.png shime2.png files to the asuka_suit directory
cp shime1.png shime2.png /usr/share/amor/pics/animated/rei_swimsuit/

# Copy the png file to the preview directory
cp rei_swimsuit_preview.png /usr/share/amor/pics/preview/
