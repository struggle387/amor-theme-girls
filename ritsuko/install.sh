...
cp ritsukorc /usr/share/amor/

# Create the directory for images if it doesn't exist
mkdir -p /usr/share/amor/pics/animated/ritsuko/

# Copy the shime1.png shime2.png files to the asuka_suit directory
cp shime1.png shime2.png /usr/share/amor/pics/animated/ritsuko/

# Copy the png file to the preview directory
cp ritsuko_preview.png /usr/share/amor/pics/preview/
